...
const mockJobs: Job[] = [
  ...
  { id: 7, title: 'Расклейщик объявлений', company: 'AdCity', location: 'Нижний Новгород', type: 'Проектная', ageRange: '14-17', salary: '13000 ₽' },
  { id: 8, title: 'Помощник в зоомагазине', company: 'Pet Shop', location: 'Новосибирск', type: 'Частичная', ageRange: '14-17', salary: '14000 ₽' },
  { id: 9, title: 'Оператор call-центра', company: 'TechSupport24', location: 'Удаленно', type: 'Гибкий график', ageRange: '16-17', salary: '22000 ₽' },
  { id: 10, title: 'Помощник флориста', company: 'Цветочный рай', location: 'Краснодар', type: 'Частичная', ageRange: '14-17', salary: '13500 ₽' },
  { id: 11, title: 'SMM-помощник', company: 'Digital Agency', location: 'Удаленно', type: 'Стажировка', ageRange: '15-17', salary: '16000 ₽' },
  { id: 12, title: 'Раздатчик флаеров', company: 'Promo Team', location: 'Москва', type: 'Проектная', ageRange: '14-17', salary: '12000 ₽' },
  { id: 13, title: 'Помощник фотографа', company: 'Photo Studio Pro', location: 'Санкт-Петербург', type: 'Частичная', ageRange: '15-17', salary: '16500 ₽' },
  { id: 14, title: 'Стажер программист', company: 'IT StartUp', location: 'Удаленно', type: 'Стажировка', ageRange: '16-17', salary: '25000 ₽' },
  { id: 15, title: 'Помощник в кинотеатре', company: 'Cinema Park', location: 'Воронеж', type: 'Частичная', ageRange: '14-17', salary: '14500 ₽' },
  { id: 16, title: 'Упаковщик товаров', company: 'Warehouse Plus', location: 'Ростов-на-Дону', type: 'Гибкий график', ageRange: '16-17', salary: '19000 ₽' },
  { id: 17, title: 'Помощник аниматора', company: 'Kids Party', location: 'Казань', type: 'Проектная', ageRange: '14-17', salary: '15000 ₽' },
  { id: 18, title: 'Контент-модератор', company: 'Social Media Corp', location: 'Удаленно', type: 'Гибкий график', ageRange: '16-17', salary: '18000 ₽' },
  { id: 19, title: 'Помощник в ветклинике', company: 'Вет-Центр', location: 'Самара', type: 'Частичная', ageRange: '15-17', salary: '14000 ₽' },
  { id: 20, title: 'Стажер видеомонтажер', company: 'Video Production', location: 'Удаленно', type: 'Стажировка', ageRange: '15-17', salary: '17000 ₽' },
  { id: 21, title: 'Помощник в магазине', company: 'Продукты 24', location: 'Уфа', type: 'Частичная', ageRange: '14-17', salary: '13000 ₽' },
  { id: 22, title: 'Тестировщик игр', company: 'Game Studio', location: 'Удаленно', type: 'Проектная', ageRange: '14-17', salary: '16000 ₽' },
  { id: 23, title: 'Помощник тренера', company: 'Fitness Club', location: 'Пермь', type: 'Частичная', ageRange: '16-17', salary: '15500 ₽' },
  { id: 24, title: 'Оператор соцсетей', company: 'Brand Media', location: 'Удаленно', type: 'Гибкий график', ageRange: '15-17', salary: '19000 ₽' },
];
