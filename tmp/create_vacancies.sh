...
API_ENDPOINT="https://functions.poehali.dev/81ba1a01-47ea-40ac-9ce8-1dc2aa32d523?resource=jobs"

SUCCESS=0
FAILED=0

# Function to create vacancy
create_vacancy() {
  local data=$1
  local title=$2
